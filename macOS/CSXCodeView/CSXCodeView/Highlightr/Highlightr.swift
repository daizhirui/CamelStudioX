...
open class Highlightr
{
    ...
    open func setTheme(to name: String) -> Bool
    {
        ...
        self._theme =  Theme(themeString: themeString)
    ...
    open func highlight(_ code: String, as languageName: String? = nil, fastRender: Bool = true) -> NSAttributedString?
    {
        ...
        {
            string = "<style>"+self._theme.lightTheme+"</style><pre><code class=\"hljs\">"+string+"</code></pre>"
    ...
    private func processHTMLString(_ string: String) -> NSAttributedString?
    {
        ...
        while !scanner.isAtEnd
        {
            ...
            if scannedString != nil && scannedString!.length > 0 {
                let attrScannedString = self._theme.applyStyleToString(scannedString! as String, styleList: propStack)
            ...
            {
                let attrScannedString = self._theme.applyStyleToString("<", styleList: propStack)
                resultString.append(attrScannedString)
                scanner.scanLocation += 1
            }
