/*
 ...
 Modified by Zhirui Dai on 10/01/2018
 */
...
class CenteringClipView: NSClipView {
    override func constrainBoundsRect(_ proposedBounds: NSRect) -> NSRect {
        ...
        // This makes the `documentView` with sizable but the width won't be magnified too big.
        if newClipBoundsRect.width < 800 {
            documentView.setFrameSize(NSSize(width: newClipBoundsRect.width - 40.0, height: documentView.frame.height))
        }
